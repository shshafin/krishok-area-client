...
const ADDRESSES = ["paba, rajshahi", "mohonpur, rajshahi", "tanor, rajshahi", "Paba. Raj", "shahmokhdum, rajshahi", "mothurdanga, rajshahi"];
const NAMES = ["Md. Mosarrof Hossain", "Rana Khan", "Md. Momin Islam", "Md. Shihab Ali", "Konika Mk", "Krishok Ami", "Shoriful Islam", "Torikul Islam"];
const HANDLES = ["mosarrofhossain", "ranakhan123", "mominrajshahikeshorhat", "mdshihabali", "santonakonikamk.SA", "krishokami1", "shorifulislam", "torikulislam"];
const AVATARS = [
...
const SEARCH_PLACEHOLDER = "\u0995\u09c0\u099f\u09a8\u09be\u09b6\u0995\u0020\u09aa\u09a3\u09cd\u09af\u0020\u0996\u09cb\u099c\u0020\u0995\u09b0\u09c1\u09a8";
const STATS = [
  {
    label: "Total Users",
    value: 47,
