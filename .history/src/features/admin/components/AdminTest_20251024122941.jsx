  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const [userRes, postRes] = await Promise.all([fetchAllUsers(), fetchPosts()]);
        ...
        if (postRes?.success && postRes.data) {
          ...
          // total posts
          const totalPosts = postRes.data.length;
          ...
          setStats((prev) =>
            prev.map((s) => {
              ...
              if (s.label === "Total Comments") return { ...s, value: totalComments };
              return s;
            })
          );
        }
