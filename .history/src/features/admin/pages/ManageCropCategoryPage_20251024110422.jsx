            ...
            <div className="card w-100">
              <div className="card-header d-flex flex-column flex-md-row gap-3 justify-content-md-between align-items-md-center">
                <h3 className="card-title mb-0">
                  Total Crop Category = [{totalCount}]
                </h3>
                ...
                <AdminDataTable
                  columns={[
                    ...
                    },
                    {
                      ...
                      render: (row) => (
                        <div className="d-flex">
                          <h5 className={highlightClass(row.categoryName)}>
                            {row.categoryName}
                          </h5>
                        </div>
                      ),
          ...
          <div
            ...
            <form
              ...
              <div className="card-bodyy">
                <div className="display-flex flex-column flex-md-row gap-3">
                  <div className="form-group amf flex-grow-1">
                    <label htmlFor="edit_cropctg_bangname">
                      Crop Bangla Name
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="form-group amf flex-grow-1">
                    <label htmlFor="edit_cropctg_engname">
                      Crop English Name
                    </label>
                    <input
                      type="text"
              ...
              <div className="card-footer faa d-flex justify-content-between">
                ...
                <button
                  type="submit"
                  className="editcropctgid btn btn-primary">
                  Save Changes
                </button>
              </div>
            </form>
