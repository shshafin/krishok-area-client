...
export default function ManageProductDetailsPage() {
  ...
  { key: "beboharerShubidha", label: "উপকারিতা ও ব্যবহার সংক্ষেপ", value: product.beboharerShubidha },
  { key: "foshol", label: "ফসল", value: product.foshol?.join(", ") },
  { key: "balai", label: "বালাই", value: product.balai?.join(", ") },
  { key: "matra", label: "মাত্রা", value: product.matra?.join(", ") },
  { key: "beboharBidhi", label: "ব্যবহারবিধি", value: product.beboharBidhi?.join(", ") },
