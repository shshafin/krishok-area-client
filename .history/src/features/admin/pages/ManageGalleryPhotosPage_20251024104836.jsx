...
import { fetchAllGalleries } from "@/api/gallery.api"; // ✅ use your actual import path
import { baseApi } from "@/config/envConfig"; // ✅ make sure you have this imported
                ...
                {isLoading ? (
                  ...
                  <div className="manage-gallery-grid">
                    {filtered.map((item, index) => (
                      <article key={index} className="manage-gallery-card">
