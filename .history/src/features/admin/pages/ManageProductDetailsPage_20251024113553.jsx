                ...
                const summaryEntries = [
                  {
                    ...
                    value: product.beboharerShubidha,
                  },
                  {
                    key: "foshol",
                    label: "ফসল",
                    value: asArray(product.foshol).join(", "),
                  },
                  {
                    key: "balai",
                    label: "বালাই",
                    value: asArray(product.balai).join(", "),
                  },
                  {
                    key: "matra",
                    label: "মাত্রা",
                    value: asArray(product.matra).join(", "),
                  },
                  {
                    key: "beboharBidhi",
                    label: "ব্যবহারবিধি",
                    value: asArray(product.beboharBidhi).join(", "),
                  },
