...
import { fetchAllProducts, deleteProduct as deleteProductApi } from "@/api/productApi";
          ...
          <div className="row mb-2">
            <div className="col-sm-6">
              ...
              <p className="text-muted mt-1 mb-0">
                Review product highlights, usage summaries, and delete outdated entries.
              </p>
            </div>
            <div className="col-sm-6">
              <ol className="breadcrumb float-sm-right">
                ...
                <li className="breadcrumb-item active">Manage Product Details</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <div className="crop-details-grid">
              {filteredProducts.map((product) => {
                ...
                const summaryEntries = [
                  { key: "beboharerShubidha", label: "Benefits", value: product.beboharerShubidha },
                  { key: "foshol", label: "Recommended Crop", value: product.foshol },
                  { key: "balai", label: "Target Pest", value: product.balai },
                  { key: "matra", label: "Dosage", value: product.matra },
                  { key: "beboharBidhi", label: "Application Instructions", value: product.beboharBidhi },
                ...
                return (
                  <article key={product._id} className={`crop-detail-card ${removing[product._id] ? "is-removing" : ""}`}>
                    <button
                      type="button"
                    ...
                    <div className="crop-detail-media">
                      ...
                      <span className="crop-detail-category badge-info">{product.category}</span>
                    </div>
                    ...
                    <div className="crop-detail-body">
                      <div className="crop-detail-header">
                        <div>
                          ...
                          <p className="crop-detail-meta">
                            <span>{product.company?.englishName || "Unknown Company"}</span>
                      ...
                      <div className="crop-detail-summary">
                        ...
                        {hasHidden && (
                          <button type="button" className="crop-detail-toggle" onClick={() => toggleExpanded(product._id)} aria-expanded={isExpanded}>
                            {isExpanded ? "Show less" : `View more (${summaryEntries.length - visibleEntries.length})`}
                          </button>
                        )}
                      </div>
                    </div>
        ...
        <div className="admin-modal-backdrop" role="presentation">
          <div className="admin-modal" role="dialog" aria-modal="true">
            ...
            <div className="admin-modal-body">
              <p className="mb-2">
                Are you sure you want to delete <strong>{confirmProduct.productName}</strong>?
              </p>
              <p className="text-muted mb-0">This action cannot be undone.</p>
            </div>
            <div className="admin-modal-footer">
              <button type="button" className="btn btn-outline-secondary btn-sm" onClick={handleCancelDelete}>Cancel</button>
