...
const RAW_PRODUCTS = [
  {
    ...
    heroImage:
      "https://images.unsplash.com/photo-1586867809830-320cb0b937a2?auto=format&fit=crop&w=900&q=80",
    summary: {
      benefits:
        "Controls common paddy weeds before germination and protects the crop for weeks.",
      crop: "Rice",
      pest: "Stem borer",
      dosage: "10 ml per 20 litres of water",
      instruction:
        "Spray in the early morning or late afternoon for best results.",
    },
  },
];
...
const normalizeProduct = (product, index) => {
  ...
  return {
    ...
    heroImage:
      product.heroImage ?? "https://picsum.photos/seed/product/640/480",
...
export default function ManageProductDetailsPage() {
  const [products, setProducts] = useState(() =>
    RAW_PRODUCTS.map(normalizeProduct).filter(Boolean)
  );
                ...
                return (
                  <article
                    ...
                    className={`crop-detail-card ${
                      removing[product.id] ? "is-removing" : ""
                    }`}>
                    <button
                      type="button"
